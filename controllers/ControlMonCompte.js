var modelMonCompte = require('../models/ModelAccueil');
module.exports = {
    
    // affichage accueil avec les différents charts (à prevoir, stock effectif et part pathologies)
    afficher_monCompte: function (req, res) {
        modelRecherche.afficher_monCompte(function (data, data2, data3) {
            // chart stock
            var lesMeds = []
            var lesDonnesMeds = []
