var modelInfosJeu = require('../models/ModelAccueil');
module.exports = {
    ...
    afficher_infosJeu: function (req, res) {
        modelInfosJeu.afficher_infosJeu(function (data, data2, data3) {
            // chart stock
            var lesMeds = []
            var lesDonnesMeds = []
